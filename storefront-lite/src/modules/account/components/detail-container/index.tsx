...
const Detail: React.FC<PropsWithChildren<DetailProps>> & {
  SubDetail: React.FC<PropsWithChildren<SubDetailProps>>
} = ({ title, children }) => {
  return (
    <div>
...
const SubDetail: React.FC<PropsWithChildren<SubDetailProps>> = ({
  title,
  children,
}) => {
  return (
